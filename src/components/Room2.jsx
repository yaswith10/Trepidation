...
const Room2 = (props) => {
    ...
    function updateHeroPos(){
        ...
        if(heroX > 1279-300) props.setroomNumber(3);
  ...
  return (
    ...
    <div id='game-page' onMouseMove={getCursorPo}>
        ...
        <div className="bloodstains absolute top-[530px] left-[751px]"></div>
        <div className="bloodstains absolute top-[163px] left-[470px]"></div>
        <div className="bloodstains absolute top-[11px] left-[788px]"></div>
        <div className="bloodstains absolute top-[537px] left-[472px]"></div>
        <div className="bloodstains absolute top-[20px] left-[6px]"></div>
        <div className="bloodstains absolute top-[412px] left-[224px]"></div>
        <div className="bloodstains absolute top-[15px] left-[618px]"></div>
    </div>
    </div>
  )
}
